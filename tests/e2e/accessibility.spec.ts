...
const stories = [
  ...
  { name: 'RouteErrorFallback', id: 'feedback-routeerrorfallback--with-home-link' },
  ...
  { name: 'EventFormDialog', id: 'dialogs-eventformdialog--empty' },
  { name: 'EventFormDialog Seeded', id: 'dialogs-eventformdialog--seeded' },
